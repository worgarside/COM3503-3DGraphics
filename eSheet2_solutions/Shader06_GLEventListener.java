...
public class Shader06_GLEventListener implements GLEventListener {
  
  private Shader shader;
    
  /* The constructor is not used to initialise anything */
  public Shader06_GLEventListener() {
  }
  ...
  public void initialise(GL3 gl) {
    shader = new Shader(gl, "vs6.txt", "fs6.txt");
    fillBuffers(gl);
  }
  ...
  public void render(GL3 gl) {
    ...
    float offsetX = (float)(Math.sin(elapsedTime)*0.5);
    float offsetY = (float)(Math.cos(elapsedTime)*0.5);
